...
difference() {
    ...
    r2=30;
    union() {
        translate([0,0,0]) cylinder(d1=optimize_fdm?11:9.6,d2=15.5, h=0.8);
        translate([0,0,0.8]) cylinder(d1=15.5,d2=15.9, h=.8);
        difference() {
            translate([0,0,1.6]) cylinder(d1=15.9,d2=12.5, h=.8);
    ...
    translate([0,0,0.58-r1]) sphere(r=r1);
    
    //translate([0,0,9.58-5.35]) cylinder(d=3.3,h=5.351);
    margin = optimize_fdm?0.2:0;
    d1 = 3.3+margin;
